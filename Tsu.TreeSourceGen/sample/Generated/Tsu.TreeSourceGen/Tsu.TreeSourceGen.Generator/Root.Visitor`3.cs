...
namespace Tsu.TreeSourceGen.Sample
{
    ...
    {
        TReturn VisitExpression(Tsu.TreeSourceGen.Sample.Expression expression, TArg1 arg1, TArg2 arg2)
        ;
    ...
    partial class Visitor<TReturn, TArg1, TArg2> : IVisitor<TReturn, TArg1, TArg2> 
    {
        ...
        
        {
            ...
            protected virtual TReturn DefaultVisit(Tsu.TreeSourceGen.Sample.Root node, TArg1 arg1, TArg2 arg2)
             => default;
