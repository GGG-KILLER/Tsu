...
namespace Tsu.TreeSourceGen.Sample
{
    ...
    partial class Visitor<TReturn, TArg1, TArg2> : IVisitor<TReturn, TArg1, TArg2> 
    {
        public virtual TReturn Visit(Tsu.TreeSourceGen.Sample.Root node, TArg1 arg1, TArg2 arg2)
        {
            ...
            TReturn VisitBinary(Tsu.TreeSourceGen.Sample.Binary binary, TArg1 arg1, TArg2 arg2) => DefaultVisit(
            binary, arg1, arg2);
            
            TReturn VisitConstant(Tsu.TreeSourceGen.Sample.Constant constant, TArg1 arg1, TArg2 arg2) => DefaultVisit(
            constant, arg1, arg2);
            
            TReturn VisitFunctionCall(Tsu.TreeSourceGen.Sample.FunctionCall functionCall, TArg1 arg1, TArg2 arg2) => DefaultVisit(
