...
namespace Tsu.Trees.RedGreen.Sample
{
    ...
    /// </summary>
    public readonly partial struct SampleList<TNode> : IReadOnlyList<TNode>, IEquatable<SampleList<TNode>>
        where TNode : global::Tsu.Trees.RedGreen.Sample.SampleNode
    {
        private readonly global::Tsu.Trees.RedGreen.Sample.SampleNode? _node;

        internal SampleList(global::Tsu.Trees.RedGreen.Sample.SampleNode? node)
        {
            _node = node;
        }

        /// <summary>
        /// Creates a singleton list of Sample nodes.
        /// </summary>/// <param name="node">The single element node.</param>
        public SampleList(TNode? node)
            : this((global::Tsu.Trees.RedGreen.Sample.SampleNode?) node)
        {
        }
        ...
        public SampleList(IEnumerable<TNode>? nodes)
            : this(CreateNode(nodes))
        {
        }

        private static global::Tsu.Trees.RedGreen.Sample.SampleNode? CreateNode(IEnumerable<TNode>? nodes)
        {
            if (nodes == null)
            {
                return null;
            ...
            var builder = (nodes is ICollection<TNode> collection) ? new SampleListBuilder<TNode>(collection.Count) : SampleListBuilder<TNode>.Create();
        ...
        internal global::Tsu.Trees.RedGreen.Sample.SampleNode? ItemInternal(int index)
        {
        ...
        public SampleList<TNode> Add(TNode node) => Insert(Count, node);

        /// <summary>
        /// Creates a new list with the specified nodes added at the end.
        /// </summary>
        /// <param name="nodes">The nodes to add.</param>
        public SampleList<TNode> AddRange(IEnumerable<TNode> nodes) =>
        ...
        public SampleList<TNode> Insert(int index, TNode node)
        {
        ...
        public SampleList<TNode> InsertRange(int index, IEnumerable<TNode> nodes)
        {
        ...
        public SampleList<TNode> RemoveAt(int index)
        {
            if (index < 0 || index > Count)
            {
                throw new ArgumentOutOfRangeException(nameof(index));
        ...
        public SampleList<TNode> Remove(TNode node) =>
        ...
        public SampleList<TNode> Replace(TNode nodeInList, TNode newNode) =>
        ...
        public SampleList<TNode> ReplaceRange(TNode nodeInList, IEnumerable<TNode> newNodes)
        {
        ...
        private static SampleList<TNode> CreateList(List<TNode> items)
        {
            if (items.Count == 0)
            {
                return default;
...
#pragma warning disable RS0041 // uses oblivious reference types
        ...
        public override bool Equals(object? obj) =>
            obj is SampleList<TNode> list && Equals(list);
        ...
        public static implicit operator SampleList<TNode>(SampleList<global::Tsu.Trees.RedGreen.Sample.SampleNode> nodes) =>
            new(nodes._node);
        ...
        /// </summary>
        /// <param name="nodes"></param>
        public static implicit operator SampleList<global::Tsu.Trees.RedGreen.Sample.SampleNode>(SampleList<TNode> nodes) =>
            new(nodes.Node);
