...
namespace GUtils.CLI.SourceGenerator.CommandManager
{
    public class CommonSymbols
    {
        ...
        /// </summary>
        public INamedTypeSymbol GUtils_CLI_Commands_CommandAttribute { get; }

        /// <summary>
        /// The <see cref="HelpDescriptionAttribute" /> type symbol.
        /// </summary>
        public INamedTypeSymbol GUtils_CLI_Commands_HelpDescriptionAttribute { get; }

        /// <summary>
        /// The <see cref="HelpExampleAttribute" /> type symbol.
        /// </summary>
        public INamedTypeSymbol GUtils_CLI_Commands_HelpExampleAttribute { get; }

        /// <summary>
        /// The <see cref="JoinRestOfArgumentsAttribute" /> type symbol.
        /// </summary>
        public INamedTypeSymbol GUtils_CLI_Commands_JoinRestOfArgumentsAttribute { get; }

        /// <summary>
        /// The <see cref="RawInputAttribute" /> type symbol.
        /// </summary>
        public INamedTypeSymbol GUtils_CLI_Commands_RawInputAttribute { get; }
        ...
        {
            this.GUtils_CLI_Commands_CommandAttribute = getSymbol ( typeof ( CommandAttribute ) );
            this.GUtils_CLI_Commands_HelpDescriptionAttribute = getSymbol ( typeof ( HelpDescriptionAttribute ) );
            this.GUtils_CLI_Commands_HelpExampleAttribute = getSymbol ( typeof ( HelpExampleAttribute ) );
#pragma warning disable CS0618 // Type or member is obsolete
            this.GUtils_CLI_Commands_JoinRestOfArgumentsAttribute = getSymbol ( typeof ( JoinRestOfArgumentsAttribute ) );
#pragma warning restore CS0618 // Type or member is obsolete
            this.GUtils_CLI_Commands_RawInputAttribute = getSymbol ( typeof ( RawInputAttribute ) );
