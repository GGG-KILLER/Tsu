namespace GUtils.Web
{
    ...
    public class CloudflareEvader
    {
        ...
        public static async Task<WebClient> CreateBypassedWebClientAsync ( string url )
        {
            ...
            catch ( WebException ex ) //We usually get this because of a 503 service not available.
            {
                ...
                var cookie_resp = ( HttpWebResponse ) await cookie_req.GetResponseAsync ( );
